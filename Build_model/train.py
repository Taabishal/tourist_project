...
# for logging to MLflow
import subprocess
import mlflow

# ngrok.set_auth_token("33GPF4TPe0dbtedYkaG4Rde61RGG_6tbrZGSsbq5kUxJPjRSDA")
# process = subprocess.Popen (["mlflow", "ui", "--port", "5000"])
# public_url = ngrok.connect(5000).public_url
# print("MLflow Tracking UI:", public_url)

# Set up MLflow tracking
mlflow.set_tracking_uri(public_url) # Commented out to use local file-based tracking
mlflow.set_experiment("tourism-prediction")

# Initialize HfApi with the token for authentication
api = HfApi(token=token)

# Load the preprocessed data from Hugging Face
# Using direct raw URLs for better compatibility with pandas.read_csv
Xtrain_path = "https://huggingface.co/datasets/happy-face1/Tourism_AIML25/raw/main/Xtrain.csv"
Xtest_path = "https://huggingface.co/datasets/happy-face1/Tourism_AIML25/raw/main/Xtest.csv"
ytrain_path = "https://huggingface.co/datasets/happy-face1/Tourism_AIML25/raw/main/ytrain.csv"
ytest_path = "https://huggingface.co/datasets/happy-face1/Tourism_AIML25/raw/main/ytest.csv"
